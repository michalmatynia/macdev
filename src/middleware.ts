...
// export function middleware(request: NextRequest) {
//   console.log('middleware working  1', request)
// }
export function middleware(request: NextRequest) {
  ...
  if (
    ...
    // I nned to test why it doesn't clean the url when I use the code below
    // const newUrl = new URL(pathname, request.url)
    // NextResponse.redirect('') // Testing if it works
